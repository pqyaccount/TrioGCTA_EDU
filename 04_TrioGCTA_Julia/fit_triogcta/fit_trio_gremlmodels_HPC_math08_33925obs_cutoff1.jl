...
if Sys.iswindows()
	mobadat = DataFrame(CSV.File("M:\\p805-qiyuanp\\TrioGCTA\\data\\MoBaPsychGen_v1_1m_math08_33925obs.moba", missingstring = "NA"))
else
	mobadat = DataFrame(CSV.File("/tsd/p805/home/p805-qiyuanp/TrioGCTA/data/MoBaPsychGen_v1_1m_math08_33925obs.moba", missingstring = "NA"))
end
