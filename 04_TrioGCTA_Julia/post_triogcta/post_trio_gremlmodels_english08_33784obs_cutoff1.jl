...
if Sys.iswindows()
    m_full = JLD.load("M:\\p805-qiyuanp\\TrioGCTA\\Step05_TrioGCTA_Julia\\results\\english08_z\\" * vari * "_" * threshold * "_full_" * sz * ".jld")["model"]
else
	m_full = JLD.load("/tsd/p805/home/p805-qiyuanp/TrioGCTA/Step05_TrioGCTA_Julia/results/english08_z/" * vari * "_" * threshold * "_full_" * sz * ".jld")["model"]
end
println("Full model")
println(m_full)
...
# MO
if Sys.iswindows()
    m_mo = JLD.load("M:\\p805-qiyuanp\\TrioGCTA\\Step05_TrioGCTA_Julia\\results\\english08_z\\" * vari * "_" * threshold * "_mo2_" * sz * ".jld")["model"]
else
    m_mo = JLD.load("/tsd/p805/home/p805-qiyuanp/TrioGCTA/Step05_TrioGCTA_Julia/results/english08_z/" * vari * "_" * threshold * "_mo2_" * sz * ".jld")["model"]
end
println("MO model")
println(m_mo)
...
# FO
if Sys.iswindows()
    m_fo = JLD.load("M:\\p805-qiyuanp\\TrioGCTA\\Step05_TrioGCTA_Julia\\results\\english08_z\\" * vari * "_" * threshold * "_fo3_" * sz * ".jld")["model"]
else
    m_fo = JLD.load("/tsd/p805/home/p805-qiyuanp/TrioGCTA/Step05_TrioGCTA_Julia/results/english08_z/" * vari * "_" * threshold * "_fo3_" * sz * ".jld")["model"]
end
println("FO model")
println(m_fo)
...
# MF
if Sys.iswindows()
    m_mf = JLD.load("M:\\p805-qiyuanp\\TrioGCTA\\Step05_TrioGCTA_Julia\\results\\english08_z\\" * vari * "_" * threshold * "_mf4_" * sz * ".jld")["model"]
else
    m_mf = JLD.load("/tsd/p805/home/p805-qiyuanp/TrioGCTA/Step05_TrioGCTA_Julia/results/english08_z/" * vari * "_" * threshold * "_mf4_" * sz * ".jld")["model"]
end
println("MF model")
println(m_mf)
...
# Indep
if Sys.iswindows()
    m_indep = JLD.load("M:\\p805-qiyuanp\\TrioGCTA\\Step05_TrioGCTA_Julia\\results\\english08_z\\" * vari * "_" * threshold * "_indep5_" * sz * ".jld")["model"]
else
    m_indep = JLD.load("/tsd/p805/home/p805-qiyuanp/TrioGCTA/Step05_TrioGCTA_Julia/results/english08_z/" * vari * "_" * threshold * "_indep5_" * sz * ".jld")["model"]
end
println("Indep model")
println(m_indep)
...
# Direct
if Sys.iswindows()
    m_direct = JLD.load("M:\\p805-qiyuanp\\TrioGCTA\\Step05_TrioGCTA_Julia\\results\\english08_z\\" * vari * "_" * threshold * "_direct6_" * sz * ".jld")["model"]
else
    m_direct = JLD.load("/tsd/p805/home/p805-qiyuanp/TrioGCTA/Step05_TrioGCTA_Julia/results/english08_z/" * vari * "_" * threshold * "_direct6_" * sz * ".jld")["model"]
end
...
# RDR
if Sys.iswindows()
    m_rdr = JLD.load("M:\\p805-qiyuanp\\TrioGCTA\\Step05_TrioGCTA_Julia\\results\\english08_z\\" * vari * "_" * threshold * "_rdr7_" * sz * ".jld")["model"]
else
    m_rdr = JLD.load("/tsd/p805/home/p805-qiyuanp/TrioGCTA/Step05_TrioGCTA_Julia/results/english08_z/" * vari * "_" * threshold * "_rdr7_" * sz * ".jld")["model"]
end
println("RDR model")
println(m_rdr)
...
for i in 2:length(ms)
    ...
    try
        ...
        println("LRT failed for model ", i, ": ", e)
    end
end
...
set_full = sqrt.(max.(diag(Ct_full), 0.0))
...
set_mo = sqrt.(max.(diag(Ct_mo), 0.0))
...
set_fo = sqrt.(max.(diag(Ct_fo), 0.0))
...
set_mf = sqrt.(max.(diag(Ct_mf), 0.0))
...
set_indep = sqrt.(max.(diag(Ct_indep), 0.0))
...
set_direct = sqrt.(max.(diag(Ct_direct), 0.0))
...
set_rdr = sqrt.(max.(diag(Ct_rdr), 0.0))
